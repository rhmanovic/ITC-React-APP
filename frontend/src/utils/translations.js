const translations = {
  en: {
    invoiceTitle: "Invoice - Order Details",
    ...
    failedToFetchOrder: "Failed to fetch order. Please try again.",
    invalidParameters: "Invalid parameters in URL",
    loading: "Loading...",
    currency: "K.D",
    ...
    status: 'Status',
    orderNumber: 'Order Number',
    OrderPlaced: 'he order has been placed.',
    amount: 'Amount',
    created: 'Created',
    id: 'ID',
    paymentMethod: 'Payment Method',
    ...
    cart: {
      ...
      startShopping: 'Start shopping and choose the right product',
    ...
    footer: {
      ...
      login: 'Login',
      cart: 'Cart',
      orderStatus: 'Order Today',
      orderStatusAll: 'Order all',
      menu: 'Menu'
    },
    accountModal: {
      myAccount: 'My Account',
    ...
    addressesModal: {
      ...
      addressEmpty: 'Address list is empty',
  ...
  ar: {
    invoiceTitle: "الفاتورة - تفاصيل الطلب",
    ...
    failedToFetchOrder: "فشل في جلب الطلب. حاول مرة أخرى.",
    invalidParameters: "معلمات غير صالحة في الرابط",
    loading: "جار التحميل...",
    currency: "د.ك",
    ...
    addAddressModal: {
      ...
      region: "المدينة",
      road: "الطريق",
      specialDirections: "إرشادات خاصة",
      ...
      office: "مكتب",
      block: "القطعة",
      enterBlock: "أدخل القطعة",
      street: "الشارع",
      enterStreet: "أدخل الشارع",
      house: "المنزل",
      enterHouse: "أدخل المنزل",
      avenue: "الجادة",
      enterAvenue: "أدخل الجادة",
      specialDirections: "إرشادات خاصة",
      enterDirections: "أدخل الإرشادات",
    ...
    cart: {
      ...
      startShopping: 'ابدأ التسوق واختر المنتج المناسب',
    ...
    footer: {
      ...
      login: 'تسجيل الدخول',
      cart: 'السلة',
      orderStatus: 'طلبات اليوم',
      orderStatusAll: 'جميع الطلبات',
      menu: 'القائمة'
    },
    accountModal: {
      myAccount: 'حسابي',
    ...
    addressesModal: {
      ...
      addressEmpty: 'قائمة العناوين فارغة',
      addAddress: 'إضافة عنوان جديد',
      deleteConfirmation: 'تأكيد الحذف',
      confirmDelete: 'هل أنت متأكد أنك تريد حذف هذا العنوان؟',
      cancel: 'إلغاء',
      delete: 'حذف',
      default: 'افتراضي',
    },
